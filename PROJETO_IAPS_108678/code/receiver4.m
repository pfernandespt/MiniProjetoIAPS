...
% receiver4 processes an audio vector and returns the detected symbol
%   symbols = receiver4(audio,channel)
%       'symbols': matrix of 4 lines with the detected symbols 
%       'audio': vertical vector of the audio sample to analyse
